...
const voicePackages = [
	{
		...
		voices: [
			...
			},
			{
				...
				voiceUrl: require("../data/audio/American_English_Beth/beth_en_us_05.mp3"),
			},
			{
				context: "shortestJourney",
				script:
					"The shortest journey from, Alexanderplein, to, Rotterdam Centraal, is estimated to take 58 mins.",
				voiceUrl: require("../data/audio/American_English_Beth/beth_en_us_06.mp3"),
			},
			{
				context: "route1",
				script:
	...
	},
	{
		...
		voices: [
			...
			},
			{
				...
				script:
					"Great! These are the possible routes that I’ve prepared for you.",
				voiceUrl: require("../data/audio/Dutch_English_Alex/alex_nl_nl_05.mp3"),
			},
			{
				context: "shortestJourney",
				script:
					"The shortest journey from, Alexanderplein, to, Rotterdam Centraal, is estimated to take 58 mins.",
				voiceUrl: require("../data/audio/Dutch_English_Alex/alex_nl_nl_06.mp3"),
			},
			{
				context: "route1",
				script:
